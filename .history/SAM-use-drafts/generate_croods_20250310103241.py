...
# 使用示例
annotations_directory = '/data2/wuxinrui/Projects/ICCV/evaluate_fm/datasets/json'  # 替换为实际目录
coco_annotation_path = "/data2/wuxinrui/Datasets/COCO/annotations/instances_val2017.json"  # COCO 标注文件路径
