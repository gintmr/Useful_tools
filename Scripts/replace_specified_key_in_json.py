...
output_file_path = '/User/project/unseen-taxonomic_cleaned_800_cate_.json'  # 输出 JSON 文件路径
replacement_file_path = '/User/project/examples_of_800unseen.json'
input_file_path = '/User/project/unseen-taxonomic_cleaned.json'
